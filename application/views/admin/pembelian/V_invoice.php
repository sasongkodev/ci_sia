<div class="box box-success flat">
    <div class="box-header">
        <div class="pull-left">
            <a href="<?= site_url('admin/pembelian') ?>" class="btn btn-default btn-flat btn-sm"><i
                    class="fa fa-arrow-circle-left"></i> Kembali</a>
        </div>
        <div class="pull-right">
            <?php if ($status_bayar == null) : ?>
                <a href="<?= site_url('admin/pembelain/bayar') ?>" class="btn btn-danger btn-flat btn-sm" data-toggle="modal" data-target="#pembayaran"><i class="fa fa-money"></i> Pembayaran</a>
            <?php else: ?>
    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-8">
                Kepada : <?= $data_pembelian->nama_suplier ?>
            </div>
            <div class="col-md-4">
                <dl class="dl-horizontal">
                    <dt>No. Invoice :</dt>
                    <dd><?= $data_pembelian->no_nota_pembelian ?></dd>
                    <dt>Tanggal Invoice :</dt>
                    <dd><?= $data_pembelian->tgl_pembelian ?></dd>
                </dl>
            </div>
        </div>
            ...
            <table class="table table-bordered">
                ...
                foreach ($data as $row) : ?>
                    <tr>
                        ...
                        <td align="center"><?= number_format($row->harga_beli * $row->qty, 2, ',', '.') ?></td>
                    </tr>
                    <?php
                    $total_qty = $total_qty + $row->qty;
                    $total_harga = $total_harga + ($row->harga_beli * $row->qty);
                endforeach; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Pembayaran Pembelian</h4>
            </div>
            <form action="<?= site_url('admin/pembelian/pembayaran') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label>No Nota</label>
                        <input type="hidden" name="id_pembelian" value="<?= $data_pembelian->id_pembelian ?>">
                        <input type="text" name="no_nota_pembelian" class="form-control" value="<?= $data_pembelian->no_nota_pembelian ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>No. Akun</label>
