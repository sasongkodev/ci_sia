 <div class="modal-header">
  ...
  <form action="<?= site_url('admin/suplier/save_update') ?>" method="post">
    <div class="modal-body">
     <div class="form-group">
      <label>Nama Suplier</label>
      <input type="hidden" name="id" value="<?= $data->id ?>">
      <input type="text" name="nama_suplier" class="form-control" placeholder="Nama Suplier" value="<?= $data->nama_suplier ?>">
    </div>
    <div class="form-group">
      <label>Alamat</label>
